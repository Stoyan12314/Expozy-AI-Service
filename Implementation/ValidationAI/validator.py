"""
EXPOZY Template Validator

Pure validation logic - no AI, no batch testing.
Import this in other scripts.

Usage:
    from validator import validate, validate_json
...
def ajv_check(data: Dict[str, Any], schema_path: str = SCHEMA_PATH) -> List[str]:
    ...
    try:
        ...
        return [f"Node.js not found ('{NODE}')"]
    except subprocess.TimeoutExpired:
        return ["Ajv validation timed out"]
    except Exception as e:
        return [f"Ajv error: {e}"]
    finally:
